...
describe('Renders Components', () => {
  ...
  let props = {
    ...
    joined: 'Thu Oct 17 2019'
  }
  beforeEach( () => {

    component = shallow(<Header name={props.name} superhost={props.superhost} img={props.img} joined={props.img}/>)
  });

  test("should render initial layout", () => {
    const component = shallow(<Header name={props.name} superhost={props.superhost} img={props.img} joined={props.img}/>);
